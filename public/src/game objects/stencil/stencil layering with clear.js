class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        // The `clear` mode sets the stencil value, rather than adding or subtracting.
        // By default, it sets it to 0.
        // This affects the whole stencil! This child is not used.
        this.add.stencil(0, 0,
            [
