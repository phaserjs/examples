var DemoA = new Phaser.Class({
    ...
    update: function (time, delta)
    {
        ...
        this.mushroom0.z = this.mushroom0.y + this.mushroom0.height / 2;
        
        this.mushroom1.x = 400 + Math.sin(-this.move) * 200;
        this.mushroom1.y = 300 + Math.cos(-this.move) * 200;
        this.mushroom1.z = this.mushroom1.y + this.mushroom1.height / 2;

        this.mushroom2.y = 300 + Math.sin(this.move) * 180;
        this.mushroom2.z = this.mushroom2.y + this.mushroom2.height / 2;
