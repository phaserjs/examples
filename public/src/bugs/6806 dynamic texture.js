class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        const texture1 = this.textures.addDynamicTexture("birdie_glow1", 1200, 900); //500, 334
        texture1.draw(birdie1, 0, 0);
        // texture1.drawFrame('birdie');

        // This is the expected usage and creates a texture as big as the image
        // const texture2 = this.textures.addDynamicTexture("birdie_glow2", 600, 500);//birdie1.width * scale, birdie1.height * scale);
        // texture1.drawFrame('birdie_glow1', 400, 300);
        // texture2.stamp('birdie_glow1', null, 400, 300);//, { scale: 0.2, originX: 1 });
        // texture2.draw(birdie1, 0, 0);
