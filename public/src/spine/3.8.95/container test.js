...
function create ()
{
    ...
    //let base = this.add.container(0, 0)

    let base = new Phaser.GameObjects.Container(this)
    ...
    for (var i = 0; i < 128; i++)
    {
        ...
        let obj = this.add.spine(x, y, 'boy', Phaser.Utils.Array.GetRandom(anims), true).setScale(s).setName('s' + i);
        base.add(obj)
    }
