...
const rootDir = './public/3.55/src/';
const examplesJSON = './public/3.55/examples.json';
const recentExamplesJSON = './public/3.55/recent-examples.json';
...
filteredTree = filteredTree.replaceAll(`public/3.55/`, ``);
filteredTree = filteredTree.replaceAll(`public\\3.55\\`, ``);
