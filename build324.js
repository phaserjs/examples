...
const rootDir = './public/3.24/src/';
const examplesJSON = './public/3.24/examples.json';
const recentExamplesJSON = './public/3.24/recent-examples.json';
...
filteredTree = filteredTree.replaceAll(`public/3.24/`, ``);
filteredTree = filteredTree.replaceAll(`public\\3.24\\`, ``);
