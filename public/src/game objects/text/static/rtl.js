...
function create() 
{
    ...
    this.add.text(700, 100, str1, { font: '32px Arial', fill: '#000000', rtl: true });
    this.add.text(700, 200, str2, { font: '32px Arial', fill: '#000000', rtl: true });
    this.add.text(700, 300, str3, { font: '32px Arial', fill: '#000000', rtl: true });
    this.add.text(700, 400, str4, { font: '32px Arial', fill: '#000000', rtl: true });
}
