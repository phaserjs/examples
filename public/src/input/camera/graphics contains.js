...
function create ()
{
    ...
    controls = (Phaser.Cameras.Controls.Smoothed) ? new Phaser.Cameras.Controls.Smoothed(controlConfig) : new Phaser.Cameras.Controls.SmoothedKeyControl(controlConfig);
