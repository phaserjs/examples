class Example extends Phaser.Scene
{
    ...
    create ()
    {
        ...
        emitter.addEmitZone({ type: 'edge', source: shape1, quantity: 64 });
        emitter.addEmitZone({ type: 'edge', source: shape2, quantity: 64 });
        emitter.addEmitZone({ type: 'edge', source: shape3, quantity: 64 });
        emitter.addEmitZone({ type: 'edge', source: shape4, quantity: 64 });
        emitter.addEmitZone({ type: 'edge', source: shape5, quantity: 64 });
    }
}
