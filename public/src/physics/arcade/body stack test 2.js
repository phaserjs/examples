...
function create ()
{
    ...
    blocks.push(this.physics.add.image(400, 80, size).setName('0').setVelocityY(200).setCollideWorldBounds(true).setInteractive());
    ...
    this.input.on('pointerdown', function (pointer) {
        ...
        blocks.push(this.physics.add.image(pointer.x, pointer.y, size).setName(blocks.length + 1).setVelocityY(0).setCollideWorldBounds(true).setInteractive());
