...
function create() 
{
    ...
    var text1 = this.add.text(20, 50, "Shadow Stroke", { font: "74px Arial Black", fill: "#c51b7d" });
    text1.setStroke('#de77ae', 16);

    //  Apply the shadow to the Stroke only
    text1.setShadow(2, 2, '#333333', 2, true, false);

    var text2 = this.add.text(20, 180, "Shadow Fill", { font: "74px Arial Black", fill: "#c51b7d" });
    text2.setStroke('#de77ae', 16);

    //  Apply the shadow to the Fill only
    text2.setShadow(2, 2, "#333333", 2, false, true);

    var text3 = this.add.text(20, 310, "Shadow Both", { font: "74px Arial Black", fill: "#c51b7d" });
    text3.setStroke('#de77ae', 16);
    //  Apply the shadow to the Stroke and the Fill (this is the default)
    text3.setShadow(2, 2, "#333333", 2, true, true);

    var text4 = this.add.text(20, 440, "Shadow None", { font: "74px Arial Black", fill: "#c51b7d" });
